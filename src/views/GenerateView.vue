            ...
            <div class="sidebar">
                <el-collapse v-model="uiStore.activeCollapse" style="margin-bottom: 24px">
                    <el-collapse-item title="Generation Options" name="1">
                        ...
                        <form-slider label="Video Frames"          prop="frames"          v-model="store.params.frames"                    :min="store.minFrames"        :max="store.maxFrames"     info="Number of consecutive video frames to generate (Video models only)."/>
                        <div>
